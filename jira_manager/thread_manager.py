        ...
        while True:
            with SmartThread.count_lock:
                if SmartThread.active_count < SmartThread.total_allotment:
                    ...
                    sleep_time = SmartThread.active_count / SmartThread.total_allotment  # Distribute wait time
                    print(f"[SmartThread] active_count ({SmartThread.active_count}) is greater than or equal to total_allotment ({SmartThread.total_allotment}), waiting for {sleep_time:.2f}s...")
